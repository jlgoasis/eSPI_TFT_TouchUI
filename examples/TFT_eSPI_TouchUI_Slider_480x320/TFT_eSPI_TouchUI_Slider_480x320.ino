...
void setup(void) {
  ...
  for (uint8_t i = 0; i < 5; i++) {
    ...
    slider[i].initSliderH(&tft, 0, 100, 70, 36 + i * 44, 30, 220, outlineColor[i], fillColor[i], nofillColor[i], i, 0);
    slider[i].drawSliderH(0);
    slider[i + 5].initSliderV(&tft, 0, 100, 20 + i * 60, 280, 30, 140, outlineColor[i], fillColor[i], nofillColor[i], i, 0);

...
class TFT_eSPI_TouchUI {
 ...
 public:
  ...
  void     initButtonUL(TFT_eSPI *gfx, int16_t x, int16_t y,
  uint16_t w, uint16_t h, uint16_t outline, uint16_t oncolor,
  uint16_t offcolor, char *label, uint8_t knob);
  ...
  void     initButtonG(TFT_eSPI *gfx, int16_t x, int16_t y, uint16_t w, uint16_t h, 
  uint16_t oncolor, uint16_t offcolor, const unsigned char * image, uint8_t knob);

  // New/alt initButton() uses upper-left corner & size
  void     initButtonGUL(TFT_eSPI *gfx, int16_t x, int16_t y, uint16_t w, uint16_t h, 
  uint16_t oncolor, uint16_t offcolor, const unsigned char * image, uint8_t knob);
...
// *** Helper Button ***
  ...
  void initButtonS(TFT_eSPI *gfx, int16_t x, int16_t y, uint16_t w, uint16_t l, 
  ...
  // Init the Horizontal Slider
    void initSliderH(TFT_eSPI *gfx, int16_t mim1, int16_t max1, int16_t x, int16_t y,
  uint16_t w, uint16_t l, uint16_t outline, uint16_t fill, uint16_t nofill,
  uint8_t knob, int8_t dv);
    ...
    void initSliderV(TFT_eSPI *gfx, int16_t mim1, int16_t max1, int16_t x, int16_t y,
  uint16_t w, uint16_t l, uint16_t outline, uint16_t fill, uint16_t nofill,
  uint8_t knob, int8_t dv);
 ...
 const unsigned char *     _image;    // Graphic Button image label
